      ...
      <el-container>
        ...
        <el-main style="padding: 20px;">
          <el-card>
            ...
            <el-row :gutter="20">
              <el-col :span="8">
                <el-statistic title="可用自习室" :value="12" />
              </el-col>
              <el-col :span="8">
                <el-statistic title="今日预约" :value="156" />
              </el-col>
              <el-col :span="8">
                <el-statistic title="使用率" :value="85.4" suffix="%" />
              </el-col>
            </el-row>

            <el-divider />

            <el-button type="primary" size="large" @click="$router.push('/reservation')">
              立即预约
            </el-button>
          </el-card>
        </el-main>
...
import { House, Calendar, Document, School ,Check , Warning} from '@element-plus/icons-vue'
